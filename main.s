.data
	...
	#Fighting scenes
	.include "images_data/Hero_background.data"
...
LeftMenuChosen:
	li t1,0
	beq t1,a1,AuxiliarBattleScreen_Left
	li t1,1
...
DrawLand:	
	...
	li t3,0x20202020
FillScreen2: 	
	beq t1,t2,DrawCharacters
	sw t3,0(t1)
	addi t1,t1,4
	j FillScreen2
DrawCharacters:	
	la a0,Hero_background
	li a1,200
	li a2,160
	lw a3,frame_zero
	jal drawImage
	
	la a0,Enemy_background
	li a1,90
	li a2,160
	lw a3,frame_zero
	jal drawImage
...
rightMenuChosen:
	...
	li t1,0
	beq t1,a1,AuxiliarBattleScreen
